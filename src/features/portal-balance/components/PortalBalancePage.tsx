            ...
            <table className="w-full min-w-[560px] border-collapse text-left text-label">
              <thead>
                <tr className="border-b border-edge text-caption text-muted">
                  ...
                  <th className="px-3 py-2 font-medium">{t("portal.colEntryType")}</th>
                  <th className="whitespace-nowrap px-3 py-2 text-right font-medium">
                    {t("portal.colAmount")}
                  </th>
                  <th className="hidden px-3 py-2 font-medium md:table-cell">{t("portal.colNote")}</th>
                  ...
                  <th className="hidden px-3 py-2 font-medium lg:table-cell">{t("portal.colRef")}</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
